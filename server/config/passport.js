...
// app.use(
//   session({
//     secret: process.env.SESSION_SECRET, // Add a session secret to your .env// const express = require("express");
const passport = require("passport");
const GoogleStrategy = require("passport-google-oauth20").Strategy;
const session = require("express-session");
const dotenv = require("dotenv");
...
passport.deserializeUser((id, done) => {
  // Logic to find user in your database by id
  // For example, you can retrieve the user's data from your DB
  done(null, { id, name: "John Doe", email: "john.doe@example.com" });
});
