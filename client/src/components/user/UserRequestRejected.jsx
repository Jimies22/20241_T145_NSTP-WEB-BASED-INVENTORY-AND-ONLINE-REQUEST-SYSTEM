          ...
          <div className="head-title">
            <div className="left">
              ...
              <ul className="breadcrumb">
                <li>
                  <Link to="/user-request/rejected">Rejected</Link>
                </li>
                <li><i className="bx bx-chevron-right" /></li>
                <li>
                  <Link to="/user-request/pending" className="active">Pending</Link>
                </li>
                <li><i className="bx bx-chevron-right" /></li>
                <li>
                ...
                <li><i className="bx bx-chevron-right" /></li>
                <li>
                  <Link to="/user" className="active">Home</Link>
                </li>
              </ul>
            </div>
          </div>
          <div className="table-data">
            <div className="pending-requests">
              <DataTable
                ...
                noDataComponent={
                  <div style={{ padding: '24px' }}>No rejected requests found</div>
                }
                responsive
                striped
                highlightOnHover
